...
import { Vector3, Quaternion as ThreeQuaternion, Object3D, Box3 } from "three";

export function convertCannonEsVector(vector: Vec3): Vector3 {
    return vector as unknown as Vector3;
}

export function convertCannonEsQuaternion(quaternion: Quaternion): ThreeQuaternion {
...
export function convertThreeQuaternion(quaternion: ThreeQuaternion): Quaternion {
